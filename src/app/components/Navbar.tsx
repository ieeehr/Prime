...
export default function Navbar() {
  ...
  <div className="flex flex-nowrap items-center justify-between w-full gap-4 sm:gap-5 md:gap-6 lg:gap-8"> */}
  ...
  <div className="flex items-center justify-between w-full gap-2 sm:gap-4 md:gap-6">
            ...
            <div key={idx} className="flex-shrink-0">
                <Image
                  ...
                  height={100}
                  priority
                  className="h-6 sm:h-8 md:h-10 lg:h-12 object-contain max-w-[50px] md:max-w-[125px] lg:max-w-[150px]  flex-shrink"
                // className="h-6 sm:h-8 md:h-10 lg:h-12 object-contain max-w-[48px] flex-shrink"
